...
<div class="row">
    <div class="mb-3 col-md-6">
        ...
        <input type="text" id="address_lane_2" name="address_lane_2" class="form-control"
...
<div id="doctor-info" class="d-none">
    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-6">
            ...
            <input type="text" id="basehospital" name="base_hospital" class="form-control"
    ...
    <div class="row">
        <fieldset class="mb-3 col-md-6">
            ...
            <div class="col-sm-9">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="daily_available" value="No"
...
<div class="mb-3">
    ...
    <div class="input-group transparent-append">
        ...
        <input type="password" class="form-control" id="dlab-password" name='password'
