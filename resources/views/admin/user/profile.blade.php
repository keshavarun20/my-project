...
@section('content')
    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="{{ route('user.profile', Auth::user()->id) }}">Profile</a>
                    </li>
                </ol>
            </div>
            <div class="row">
                    ...
                    <div class="profile card card-body px-3 pt-3 pb-0">
                        <div class="profile-head">
                            ...
                            <div class="profile-info">
                                <div class="profile-photo" data-bs-toggle="modal"
    ...
    <div class="modal fade" id="changeProfilePictureModal" tabindex="-1" aria-labelledby="changeProfilePictureModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('user.profile_picture', $user->id) }}" method="POST"
                        ...
                        <div class="modal-body">
                            <div class="input-group mb-3">
                                ...
                                <div class="form-file">
                                    <input type="file" class="form-file-input form-control" id="profile_picture"
                    ...
                    <form action="{{ route('user.profile_picture.delete', $user->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <div class="modal-footer">
