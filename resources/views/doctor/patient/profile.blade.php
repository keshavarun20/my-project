                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        @foreach($medicals as $medical)
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#diagnosisModal{{ $medical->id }}">
                                {{ $medical->diagnosis }}
                            </button>

                            <div class="modal fade" id="diagnosisModal{{ $medical->id }}" tabindex="-1" aria-labelledby="diagnosisModal{{ $medical->id }}Label" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="diagnosisModal{{ $medical->id }}Label">{{ $medical->diagnosis }}</h5>
                                        ...
                                        <div class="modal-body">
                                            <table class="table table-striped table-responsive-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        {{-- <td>{{ $medical->management_plan['drug_name'] }}</td>
                                                        <td>{{ $medical->management_plan['dose'] }}</td>
                                                        <td>{{ $medical->management_plan['route'] }}</td>
                                                        <td>{{ $medical->management_plan['frequency'] }}</td> --}}
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="d-none" id="family">
                                            <div class="row">
                                                <div class="input-primary">
                                                    ...
                                                    <textarea name="family_history" class="form-control " id="family_history" placeholder="Family History of Chronic illnesses"></textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                        ...
                                        <div id="v-pills-social" class="tab-pane fade">
                                            <div class="d-none" id="social">
                                                ...
                                                <div class="input-primary">
                                                    ...
                                                    <input type="number" name="monthly_income" class="form-control" id="monthly_income" placeholder="Monthly Income">
                                                </div>
                                                <div class="input-primary">
