                    ...
                    <div class="collapse navbar-collapse justify-content-between">
						...
						{{-- <li>
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"  data-toggle="tooltip" data-placement="top" title='@if (Auth::user()->role->name == 'Doctor')
								...
								@endif'>
									...
									<img src="{{ Auth::user()->getFirstMediaUrl('profile_picture') }}" class="img-fluid rounded-circle" alt="">
								@else
